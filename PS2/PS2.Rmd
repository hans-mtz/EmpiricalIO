...
knitr::kable(res, digits = 4, 
             ...
             format.args = list(big.mark = ",", scientific = FALSE)) %>%
              ...
              kableExtra::add_footnote("Coefficient estimates and standard errors calculated using jackknife resampling with 100 iterations.")
